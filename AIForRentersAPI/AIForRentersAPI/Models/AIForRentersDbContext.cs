...
namespace AIForRentersAPI.Models
{
    public partial class AIForRentersDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=aiforrenters.database.windows.net;Initial Catalog=AIForRentersDB;User ID=mpernar;Password=PassForAzure123;Connect Timeout=60;Encrypt=True;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"); 
            }
        }

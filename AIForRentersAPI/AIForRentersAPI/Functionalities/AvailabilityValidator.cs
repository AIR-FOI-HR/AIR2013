                    ...
                    using (var context = new AIForRentersDbContext())
                    {
                        ...
                        if (newDatesDays == null)
                        {
                            ...
                            if (availability == null)
                            {
                                ...
                                //AvailabilitiesController availabilitiesController = new AvailabilitiesController(context);
                                //var resultNewAvailability = availabilitiesController.PostAvailability(newAvailability);
                                ...
                                req.Processed = true;
                                req.Confirmed = false;
                                req.ResponseBody = emailBody;
                                req.ResponseSubject = emailSubject;

                                //RequestsController requestsController = new RequestsController(context);
                                //var resultUpdateRequest = requestsController.PutRequest(req.RequestId, req);
